...
const tom = 'Tom', firstTom = 'Hanks', secondTom = 'Cruise'
...
console.info(summerMessage.toLowerCase())
...
console.error(winterMessage.toUpperCase())
...
console.warn(winterMessage.indexOf('v'))
...
console.warn(winterMessage.lastIndexOf('n'))
...
const reminder = 10 % 3
console.error('O resto é', reminder)
...
let episodes = 6
episodes++
console.log(episodes +' episódios')
...
let newName = name.replace(/w/g,'W') //global replacement
console.info(newName)

newName = name.replace('w','W')
newName = newName.replace('w','W') //jeito tosco
console.info(newName)
